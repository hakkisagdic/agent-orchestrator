...
function Show-Doctor([string]$Root) {
  ...
  if ($py) {
    ...
    Write-Host "          full ao available: pip install ao-orchestrator" -ForegroundColor DarkGray
  } else {
    ...
    Write-Host "          winget install Python.Python.3.12; pip install ao-orchestrator" -ForegroundColor DarkGray
  }
}
